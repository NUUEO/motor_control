...
#python motor_control/qt_example/mainWindow/main.py 
class Stats(QMainWindow):
    ...
    def stop(self):
        #self.timer.singleShot(1000,lambda:self.ser.write(bytes(com.stop(1),encoding='ASCII')))
        self.timer.singleShot(1000,lambda:self.ser.write(bytes(com.stop(2),encoding='ASCII')))
        self.timer.singleShot(2000,lambda:self.ser.write(bytes(com.stop(3),encoding='ASCII')))
    ...
    def backhome(self):
        ...
        self.key_num = 0
        self.data = data
        self.timer.singleShot(2000,lambda:self.ui.textBrowser.setText(f"目前倍率{self.magnification}"))
